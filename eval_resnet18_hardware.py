...
def single_stream_eval(
    x, model_path, output_path, optimization_vars, forward_outputs, forward_inputs, accelerator_path, mapping_path, name, mode
):
    ...
    logging.critical(f"{name} : {x}, {latency}, {energy}, {memory}, {total_memory_cost}")
...
if __name__ == "__main__":
    ...
    accelerator_path2 = "stream/stream/inputs/examples/hardware/tpu_like_two_core_best.yaml"
    mapping_path = "stream/stream/inputs/examples/mapping/tpu_like_quad_core_fused_ga_elementwise2.yaml"
    mapping_path2 = "stream/stream/inputs/examples/mapping/tpu_like_quad_core_fused_ga_elementwise2_best.yaml"
    ...
    output = "results/fused_results5/"
    # Prepare AC evaluation inputs
    output_path_ac = f"{output}ac/"
    Path(output_path_ac).mkdir(parents=True, exist_ok=True)
    optimization_vars_ac, model_path_ac, forward_inputs_ac, forward_outputs_ac = generate_model(output_path_ac)
    x_ac = [
        False,False,False,False,False,False,False,False,False,False,False,False,False,False,False,False,False,False
    ]
    # Prepare HO evaluation inputs
    output_path_ho = f"{output}ho/"
    Path(output_path_ho).mkdir(parents=True, exist_ok=True)
    optimization_vars_ho, model_path_ho, forward_inputs_ho, forward_outputs_ho = generate_model(output_path_ho)
    x_ho = [
        False,False,False,False,False,False,False,False,False,False,False,False,False,False,False,False,False,False
    ]

    # Run all four evaluations in parallel: AC+fused, AC+lbl, HO+fused, HO+lbl
    args = [
        (
            x_ac,
            model_path_ac,
            output_path_ac,
            optimization_vars_ac,
            forward_outputs_ac,
            forward_inputs_ac,
            accelerator_path,
            mapping_path,
        ...
        (   [False,False,False,False,False,False,False,True,True,False,False,True,False,True,False,True,False,False],
            model_path_ac,
            output_path_ac,
            optimization_vars_ac,
            forward_outputs_ac,
    ...
    with Pool(processes=2) as pool:
        results = pool.starmap(single_stream_eval, args)
